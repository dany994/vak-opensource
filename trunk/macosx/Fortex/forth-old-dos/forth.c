...
register c;
{
	...
	case hex:
		...
		switch (c) {
		case 'a': case 'A': case ' ': case '€': return (10);
		case 'b': case 'B': case '¡': case '': return (11);
		case 'c': case 'C': case 'æ': case '–': return (12);
		case 'd': case 'D': case '¤': case '„': return (13);
		case 'e': case 'E': case '¥': case '…': return (14);
		case 'f': case 'F': case 'ä': case '”': return (15);
		}
		return (-1);
	}
	return (-1);
